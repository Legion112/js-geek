...
(function (window, $, Routing, swal) {
    ...
    var RepLogApp = function () {
        ...
        _createClass(RepLogApp, [{
            ...
            value: function _addRow(repLog) {
                ...
                var tplText = rowTemplate(repLog);
    ...
    var rowTemplate = function rowTemplate(repLog) {
        return upper(_templateObject, repLog.totalWeightLifted, repLog.itemLabel, repLog.reps, repLog.totalWeightLifted, repLog.links._self);
    };
